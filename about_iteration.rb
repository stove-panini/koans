...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # The inject method iterates through an array, the results accumulating
    # in a "register" which is factored into the next iteration.
    #
    # In the examples above, "sum" and "product" are the accumulator register
    # and "item" is the element of the array being worked on. The parameter of
    # the inject method is the default value of the accumulator.
    #
  ...
  #
  # Seems unnecessary to create the extra variable?
